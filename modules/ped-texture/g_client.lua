...
jo.pedTexture.variations = {
  ...
  spots = {
    { label = "none", value = false },
    { label = "spots_var0", value = { id = 0 } },
    { label = "spots_var1", value = { id = 1 } },
    { label = "spots_var2", value = { id = 2 } },
    { label = "spots_var3", value = { id = 3 } },
    { label = "spots_var4", value = { id = 4 } },
    { label = "spots_var5", value = { id = 5 } },
    { label = "spots_var6", value = { id = 6 } },
    { label = "spots_var7", value = { id = 7 } },
    { label = "spots_var8", value = { id = 8 } },
    { label = "spots_var9", value = { id = 9 } },
    { label = "spots_var10", value = { id = 10 } },
    { label = "spots_var11", value = { id = 11 } },
    { label = "spots_var12", value = { id = 12 } },
    { label = "spots_var13", value = { id = 13 } },
    { label = "spots_var14", value = { id = 14 } },
    { label = "spots_var15", value = { id = 15 } },
  }
}
